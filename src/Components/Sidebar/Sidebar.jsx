...
const Sidebar = () => {
  ...
  return (
    <>
        <div className=' h-full flex-col w-[25%] gap-2 text-white p-2 hidden lg:flex'>
            ...
            <div className=" bg-[#121212] h-[85%] rounded">
                <div className=" p-4 flex items-center justify-between">
                    <div className=" flex items-center gap-3">
                        <img className=" w-8" src={assets.stack_icon} alt="Stack image" />
                ...
                <div className=" p-4 bg-[#242424] m-2 rounded flex flex-col items-start font-semibold">
